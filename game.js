...
(function () {
  ...
  victoryOverlay.innerHTML = `
    <div class="victory-card">
      ...
      <p>¡MISIÓN CUMPLIDA!</p>
      <h2>¡Enhorabuena, campeón!</h2>
      <span>Has encontrado y eliminado las 30 defensas. Tu visión táctica está más afilada que nunca.</span>
  ...
  function handleCorrect(square) {
    ...
    resultTitle.textContent = "¡Defensa eliminada!";
    resultText.textContent = `Jugada: ${activeLevel.firstMove}`;
    updateHud();
